  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-20">
        <div className="container max-w-screen-2xl px-4">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Our Team in Action</h2>
            <p className="text-muted-foreground">Dedicated professionals ensuring your packages arrive safely and on time</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="relative mb-4 aspect-[4/3] overflow-hidden rounded-2xl shadow-md">
                  <Image
                    src={item.src}
                    alt={item.title}
                    fill
